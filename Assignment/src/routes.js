...
const ProductsDetail = React.lazy(() => import('./views/products/ProductDetail'))
...
const PublicRoutes = [
  ...
  // Product routes
  { path: '/products', name: 'Products', element: Products, requiredRole: ['Admin', 'WarehouseStaff', 'StoreManager'] },
  {
    path: '/products/add',
    name: 'Add Product',
    element: ProductsAdd,
  ...
  },
  {
    ...
    name: 'Shipper',
    element: Shipper,
    requiredRole: ['Admin', 'StoreManager', 'WarehouseStaff'],
  },
  {
    path: '/Shippers/:id',
    name: 'Edit Shipper',
